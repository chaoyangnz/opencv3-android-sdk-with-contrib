...
//                   iwiCopyMakeBorder
///////////////////////////////////////////////////////////////////////////// */
IW_DECL(IppStatus) iwiCopyMakeBorder(const IwiImage *pSrcImage, IwiImage *pDstImage, IwiBorderSize borderSize, IwiBorderType border, const Ipp64f *pBorderVal, const IwiCopyMakeBorderParams *pAuxParams, const IwiTile *pTile)
{
    IppStatus status;
